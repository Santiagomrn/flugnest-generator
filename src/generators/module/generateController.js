...
export const generateController = (opts) => {
...
${belongsUser ? "import { IsOwner } from '@modules/auth/decorators/isOwner.decorator';" : ""}
${
  belongsUser ? "import { ValidateJWT } from '@modules/auth/decorators/validateJWT.decorator';" : ""
}
${belongsUser ? "import { FilterOwner } from '@decorators/filterOwner.decorator';" : ""}
${belongsUser ? "import { AppendUser } from '@decorators/appendUser.decorator';" : ""}
